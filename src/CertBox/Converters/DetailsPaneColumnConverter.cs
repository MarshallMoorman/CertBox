    ...
    public class DetailsPaneColumnConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (hasSelection)
            {
                ...
                {
                    new GridLength(3, GridUnitType.Star), new GridLength(5, GridUnitType.Pixel),
            ...
            else
            {
                ...
                return new GridLength[] { new GridLength(1, GridUnitType.Star), new GridLength(0), new GridLength(0) };
            }
        }
